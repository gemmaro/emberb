...
(setenv "PERL5LIB"
        (string-append (getenv "PWD") "/_translation/po4a/lib:"
                       (getenv "PERL5LIB")))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1zqy994fr0pf3pda0x3mmkhgnfg4hd12qp5bh1s1xm68l00viwhj"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1zj6sr1k8w59mmi27rsii0v8xyy2rnsi09nqvwpgj1q10yq1mlis"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0va3brhgc0lsvayjizyhzdybikzlyx9kfqpdgdglclbwb5611kf9"))))
    (build-system ruby-build-system)
    (arguments
     `(#:tests? #f)) ;TODO
