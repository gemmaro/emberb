...
1. You're writing some fancy application in C or C++ and you want some parts
   of your code to leverage the dynamic flexibility of Ruby. You can run the
   Ruby interpreter inside of your application and use the API to retrieve
   the results of Ruby code.
2. You're writing some fancy application in Ruby and you want some parts of
   your code to leverage the speed and power of C (or an existing C
   library). You can expose C code to Ruby using the API and compile a
   special library that Ruby can `require`.
...
{% highlight c %} {% include c/eval.h %} {% endhighlight %}
...
{% highlight c %} {% include c/checktype.h %} {% endhighlight %}
...
{% highlight c %} {% include c/check_p.h %} {% endhighlight %}
...
{% highlight c %} {% include c/type.h %} {% endhighlight %}
...
{% highlight c %} {% include c/printf.h %} {% endhighlight %}
...
{% highlight c %} {% include c/funcall.h %} {% endhighlight %}

This is roughly equivalent to the Ruby code

{% highlight ruby %} {% include c/funcall.rb %} {% endhighlight %}
...
{% highlight c %} {% include c/proc.h %} {% endhighlight %}
...
{% highlight c %} {% include c/block.h %} {% endhighlight %}
...
{% highlight c %} {% include c/require.h %} {% endhighlight %}
...
{% highlight c %} {% include c/load.h %} {% endhighlight %}
...
{% highlight c %} {% include c/raise.h %} {% endhighlight %}
...
{% highlight c %} {% include c/danger.h %} {% endhighlight %}
...
{% highlight c %} {% include c/handle.h %} {% endhighlight %}
...
{% highlight c %} {% include c/rescue2.h %} {% endhighlight %}
...
{% highlight c %} {% include c/protect.h %} {% endhighlight %}
...
{% highlight c %} {% include c/ensure.h %} {% endhighlight %}
...
{% highlight c %} {% include c/gc.h %} {% endhighlight %}
...
{% highlight c %} {% include c/ivar.h %} {% endhighlight %}
...
{% highlight c %} {% include c/constant.h %} {% endhighlight %}
...
{% highlight c %} {% include c/const_get.h %} {% endhighlight %}
...
{% highlight c %} {% include c/module.h %} {% endhighlight %}

Classes work the same way but they also need a superclass.

{% highlight c %} {% include c/class.h %} {% endhighlight %}
...
{% highlight c %} {% include c/methodc.h %} {% endhighlight %}
...
{% highlight c %} {% include c/scan.h %} {% endhighlight %}
...
{% highlight c %} {% include c/methodex.h %} {% endhighlight %}
...
{% highlight c %} {% include c/checkblock.h %} {% endhighlight %}
...
{% highlight c %} {% include c/yield.h %} {% endhighlight %}
...
{% highlight c %} {% include c/super.h %} {% endhighlight %}
...
{% highlight c %} {% include c/methodr.h %} {% endhighlight %}
...
{% highlight c %} {% include c/modulefunc.h %} {% endhighlight %}

### Other Stuff ###

Some simple API functions for class/method definitions:

{% highlight c %} {% include c/etc.h %} {% endhighlight %}
...
{% highlight ruby %} {% include c/new.rb %} {% endhighlight %}
...
{% highlight c %} {% include c/wrap.h %} {% endhighlight %}
...
{% highlight c %} {% include c/makestruct.h %} {% endhighlight %}
...
{% highlight c %} {% include c/mark.h %} {% endhighlight %}
...
{% highlight c %} {% include c/thread.h %} {% endhighlight %}
...
{% highlight c %} {% include c/gvl2.h %} {% endhighlight %}
...
{% highlight c %} {% include c/gvl.h %} {% endhighlight %}
...
{% highlight c %} {% include c/with_gvl.h %} {% endhighlight %}
